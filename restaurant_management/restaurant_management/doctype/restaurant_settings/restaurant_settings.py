...
class RestaurantSettings(Document):
    ...
    def settings_data(self):
        ...
        return dict(
            ...
            exceptions=[
                item
                for item in restaurant_settings.restaurant_exceptions
    ...
    def rooms_access(self):
        pos_profile_name = self.get_current_pos_profile_name()
        # frappe.msgprint(str(pos_profile_name))
        ...
        if pos_profile_name is not None:
            ...
            # frappe.msgprint(str(permission_parent))
            ...
            # frappe.msgprint(str(restaurant_permissions))
            rr = ()
            ll = []
            for item in restaurant_permissions:
                ll.append(item.room)
                # frappe.msgprint(str(item.room))
